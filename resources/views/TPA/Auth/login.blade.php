...
@section('content')
    <form action="{{ route('TPA.login_process') }}" method="post">
        ...
        <!-- formulaire connexion -->
            ...
            @else
                <h3 class="h3c"> Pas encore de compte ? :     <a class="h3c" href="{{route('TPA.inscription')}}"> Soumettre </a></h3> <br>
                <a class="h3c" href="{{route('TPA.reset_pre_process')}}">Mot de passe oublie ?</a> <br>
            @endif
