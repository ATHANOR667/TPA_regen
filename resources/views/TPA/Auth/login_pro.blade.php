...
@section('content')
    <form  method="post">
        ...
        <h3 class="h3c">Connexion compte Pro</h3>
        ...
        @else
            <h3 class="h3c"> Pas encore de compte Pro ? :     <a class="h3c" href="{{route('TPA.inscription_pro',['part'=>$part])}}"> S'inscrire </a> <br></h3>
        @endif
