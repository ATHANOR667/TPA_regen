...
@section('content')
    ...
    @foreach($missions as $mission)
        <div>
            ...
            <div class="divchoix"><a class="menu btnaffplus" href="{{route('TPA.mission_show',['mission'=>$mission->id,'pro'=>$pro])}}" >Afficher plus</a></div>
        </div>
        ...
        <div class="block8" >
            @foreach($missions_r as $mission_r)
                <div>
                    ...
                    <div class="divchoix"><a class="menu btnaffplus" href="{{route('TPA.mission_show',['mission'=>$mission_r->id,'pro'=>$pro])}}" >Afficher plus</a></div>
                </div>
        ...
        <div class="block8" >
            @foreach($missions_a as $mission_a)
                <div>
                    ...
                    <div class="divchoix"><a class="menu btnaffplus" href="{{route('TPA.mission_show',['mission'=>$mission_a->id,'pro'=>$pro])}}" >Afficher plus</a></div>
                </div>
