            ...
            <div class="block8" >
                @foreach($missions_a as $mission_a)
                    ...
                    <div>
                        ...
                        <div class="divchoix"><h3 class="element">Remuneration : {{$mission_a->remuneration}}</h3></div>
                        <div class="divchoix"><h3 class="element">Joindre au : {{$tel->num_tel}}</h3></div>
                        <div class="divchoix"><a class="menu btnaffplus" href="{{route('TPA.mission_show_part',['mission'=>$mission_a,'part'=>$part])}}" >Afficher plus</a></div>
                    </div>
